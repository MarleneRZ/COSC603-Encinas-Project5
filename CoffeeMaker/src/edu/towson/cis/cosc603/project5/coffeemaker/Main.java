...
public class Main {
    ...
    public static void deleteRecipe() {
        ...
        //Marlene: storing the name of recipe to delete for displaying later
        final String recipeToDeleteName = recipes[recipeToDelete].getName();
        
        boolean recipeDeleted = coffeeMaker.deleteRecipe(recipes[recipeToDelete]);
        
        if(recipeDeleted) System.out.println(recipeToDeleteName + " successfully deleted.");
	    else System.out.println(recipeToDeleteName + "could not be deleted.");
